...
namespace TrackMED.Controllers
{
    ...
    public class ComponentController : Controller
    {
        ...
        */
        ...
        public ComponentController(IEntityService<Component> entityService,
        ...
        */
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            List<ProviderOfService> serviceproviderRecords = await _serviceproviderService.GetEntitiesAsync();
            sl = new SelectList(serviceproviderRecords.OrderBy(x => x.Desc), "Id", "Desc", Entity.ProviderOfServiceID).ToList();
            if (Entity.ProviderOfServiceID == null)
            {
                sl.Insert(0, new SelectListItem { Value = "0", Text = "Please Select", Selected = true });
            }
                                         ...
                                         Component component)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    component.ProviderOfServiceID = component.ProviderOfServiceID != "0" ? component.ProviderOfServiceID : null;
